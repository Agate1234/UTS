    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Nama</label>
                    <input value="" type="text" name="supplier_name" id="supplier_name" class="form-control" required>
                    <small id="error-supplier_name" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Alamat</label>
    ...
    $(document).ready(function() {
        $("#form-tambah").validate({
            rules: {
                ...
                supplier_name: {required: true, minlength: 3, maxlength: 100},
